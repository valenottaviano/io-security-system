...
export default function AboutUs() {
    return <section className="min-h-screen bg-neutral-900 flex flex-col-reverse md:flex-row items-center px-[10vw] md:px-[10vw] lg:px-[20vw] py-20">
